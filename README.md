...
Node.js app architecture showcase using [NestJS](https://nestjs.com/), [Typescript](https://www.typescriptlang.org/), [MongoDB](https://www.mongodb.com/) and [Mongoose](http://mongoosejs.com/) as ORM. The project has an implementation of an authentication system that uses JSON Web Token to manage users' login data in Node.js web server. You can start your NestJS projects building on this boilerplate.
